...
<%@include file="investment_main_header.jsp" %>

  <!-- Page Content -->
  <div class="container">
  <!-- <table class="divi">
  	<tr>
  		<th><button type="button" class="btn-20">진행중인 투자</button></th>
  		<th><button type="button" class="btn-20">오픈 예정인 투자</button></th>
  		<th><button type="button" class="btn-20">완료된 투자</button></th>
  	</tr>
  </table>
  <table class="cate">
  	<tr>
  		<th><button type="button" class="btn-2">전체보기</button></th>
...
<c:forEach var="app" items="${approvedInvestment}" varStatus="status">
      <div class="col-lg-3 col-md-6 mb-4">
        ...
        <form name="story" method="post" action="${pageContext.request.contextPath}/investment/investmentStory">
        <input type="hidden" name="investmentTotalProjectNo" value="${app.investmentTotalProjectNo }"/>
        <c:set var="app2" value="${InvestmentMainImage[status.index]}" />        
