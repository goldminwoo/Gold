...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/reward_item1_billingReservation.css" />
<script src="${pageContext.request.contextPath}/js/jquery.js"></script>
<script src="${pageContext.request.contextPath}/js/jquery.min.js"></script>
<script
	src="${pageContext.request.contextPath}/js/bootstrap.bundle.min.js"></script>
<script src="https://ssl.daumcdn.net/dmaps/map_js_init/postcode.v2.js"></script>
<script src="${pageContext.request.contextPath}/js/reward_payment.js"></script>

</head>
<body>
	<%@include file="../header.jsp"%>
	<form name="rewardFunding" method="post" action="${pageContext.request.contextPath}/reward/rewardBillingReservationOk" >
	...
	<div class="billingReservation">
		...
		<div class="billingReservationBody">
			<div class="orderList">
				...
				<p class="orderConfiguration">${options }</p>
				<p class="sum">
