...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/manager_reward.css">
</head>
<body>
		...
		<c:if test="${!empty rewardList}">
			<c:forEach var="list" items="${rewardList}">
				<tr style="cursor: pointer;"
					onClick="location.href='${pageContext.request.contextPath}/manager/rewardInfo?rewardTotalProjectNo=${list.rewardTotalProjectNo}'">
					<td>${list.rewardTotalProjectNo}</td>
					<td>${list.id}</td>
					<td>${list.name}</td>
