...
public interface StudioDAO {
	...
	void updateRewardSoldEa(MemberRewardFundingVO memberRewardFundingVO);//투자 팔린개수 증가
	void updateInvestmentSoldEa(MemberInvestmentFundingVO memberInvestmentFundingVO);//리워드 팔린개수 증가
	
	int investmentIdCount(String id);
	int rewardIdCount(String id);
	...
	List<String> investmentProduct();//투자 상품 불러오기
	List<String> rewardProduct();//리워드 상품 불러오기
}
