...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/manager_report_complete.css">
</head>
<body>
...
<h1>신고처리 완료</h1>
	...
	onClick = "location.href='${pageContext.request.contextPath}/manager/reportYetInfo'">
			<td>번호</td>
			<td>자유게시판</td>
			<td>광고입니다.</td>
			<td>AAA</td>
