...
<body>
   ...
   <div id="board_area">
      ...
      <form action="${pageContext.request.contextPath}/board/modifiyBoardOk"
         method="post" id="frm">

         <table class="write-table">
            <tr>
               <td td align="center" width="50" style="font-weight: bold; font-size: 20px;">제목</td>
               <td><input type="text" name="title" size="101" value="${boardVO.title}" id="writeTitle"></td>
            </tr>
            <tr>
               <td align="center" width="50" style="font-weight: bold;font-size: 20px;">내용</td>
               <td width="800"><textarea name="editor" id="editor" rows="10"
                     cols="100" style="width: 766px; height: 412px;">${boardVO.editor}</textarea></td>
            </tr>
            <tr class="writeBtn">
               <td><input type="hidden" name="page" value="${page}">
               <input type="hidden" name="no" value="${boardVO.no}"></td>
               <td><input type="submit" id="savebutton" value="수정" style="cursor:pointer;">
               <input type="button" id="listbutton" value="목록" onclick="location='/treeproject/board/list';" style="cursor:pointer;"></td>
            </tr>
         </table>
      </form>
